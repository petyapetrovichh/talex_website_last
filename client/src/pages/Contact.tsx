        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="space-y-6 text-left" style={{width: '100%', maxWidth: 'none'}}>
              {/* Creator Section */}
              <div>
                <p style={{fontSize: '18px', fontWeight: '400', color: '#000000', lineHeight: '1.6', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}}>
