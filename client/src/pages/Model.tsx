 ...
 "Reward Pool" to reward those who discovered the content earlier.
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
              ...
              <div>
                ...
                <div className="mt-12 p-6 bg-[#F0FDF4] rounded-xl border border-[#6FF000]/20" style={{width: '588px'}}>
                  ...
                  <p className="text-sm text-gray-700" style={{color: '#000000', fontSize: '18px', marginLeft: '15px'}}>
        ...
        <section className="py-32 bg-gradient-to-b from-white to-[#F0FDF4] text-center relative overflow-hidden" style={{backgroundImage: 'url(/images/new-way-value-discovery.png)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
          <div className="container relative z-10">
            ...
            <p className="text-xl text-gray-600 mb-12 mx-auto whitespace-nowrap" style={{color: '#000000', width: '100%', fontWeight: '500'}}>
...
incentivizing early discovery and dissemination.
        ...
        {/* 4. Back to Creating Real Value */}
        <section className="py-24 bg-white" style={{marginTop: '0px'}}>
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-2 font-serif" style={{fontWeight: '400', fontFamily: '"Abril Fatface", serif', fontSize: '39px'}}>Back to Creating Real Value</h2>
              <p className="text-gray-500 text-sm uppercase tracking-widest" style={{fontWeight: '500'}}>The User-Driven Business Model</p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8 max-w-7xl mx-auto">
              <div className="flex flex-col items-center group">
                <div className="w-20 h-20 mb-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center">
                  <img src="/images/creators-earn-icon.png" alt="Creators Earn" className="w-full h-full object-contain" />
                </div>
                <h3 className="text-lg font-bold mb-3 text-center" style={{fontSize: '20px', fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'}}>Creators Earn</h3>
                <p className="text-gray-600 text-sm leading-relaxed text-center" style={{color: '#000000', fontSize: '16px'}}>
                  Direct revenue from every piece of content
                </p>
              </div>
              <div className="flex flex-col items-center group">
                <div className="w-20 h-20 mb-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center">
                  <img src="/images/users-control-icon.png" alt="Users Control" className="w-full h-full object-contain" />
                </div>
                <h3 className="text-lg font-bold mb-3 text-center" style={{fontSize: '20px', fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'}}>Users Control</h3>
                <p className="text-gray-600 text-sm leading-relaxed text-center" style={{color: '#000000', fontSize: '16px'}}>
                  Curate and filter content with their money
                </p>
              </div>
              <div className="flex flex-col items-center group">
                <div className="w-20 h-20 mb-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center">
                  <img src="/images/quality-rewarded-icon.png" alt="Quality Rewarded" className="w-full h-full object-contain" />
                </div>
                <h3 className="text-lg font-bold mb-3 text-center" style={{fontSize: '20px', fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'}}>Quality Rewarded</h3>
                <p className="text-gray-600 text-sm leading-relaxed text-center" style={{color: '#000000', fontSize: '16px'}}>
                  Great content rises naturally
                </p>
              </div>
              <div className="flex flex-col items-center group">
                <div className="w-20 h-20 mb-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center">
                  <img src="/images/no-guaranteed-returns-icon.png" alt="No Guaranteed Returns" className="w-full h-full object-contain" />
                </div>
                <h3 className="text-lg font-bold mb-3 text-center" style={{fontSize: '20px', fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'}}>No Guaranteed Returns</h3>
                <p className="text-gray-600 text-sm leading-relaxed text-center" style={{color: '#000000', fontSize: '16px'}}>
                  Risk and reward aligned
                </p>
              </div>
            </div>
          </div>
        ...
        {/* 5. Win-Win-Win ecosystem */}
        <section className="py-24 bg-white" style={{marginTop: '0px'}}>
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-2 font-serif" style={{fontWeight: '400', fontFamily: '"Abril Fatface", serif', fontSize: '39px'}}>Win-Win-Win ecosystem</h2>
              <p className="text-gray-500 text-sm uppercase tracking-widest" style={{fontWeight: '500'}}>How TaleX Benefits Everyone</p>
            </div>

            <div className="max-w-4xl mx-auto space-y-8">
              <div className="flex gap-6 items-start group">
                <div className="w-16 h-16 rounded-full bg-[#6FF000] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <span className="text-2xl font-bold" style={{color: '#000000'}}>1</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2" style={{fontSize: '24px', fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'}}>Creators</h3>
                  <p className="text-gray-600 leading-relaxed" style={{color: '#000000', fontSize: '18px', marginLeft: '15px'}}>
                    Monetize every piece of content. No gatekeepers, no algorithms hiding your work. Your audience pays directly for what you create.
                  </p>
                </div>
              </div>
              <div className="flex gap-6 items-start group">
                <div className="w-16 h-16 rounded-full bg-[#6FF000] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <span className="text-2xl font-bold" style={{color: '#000000'}}>2</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2" style={{fontSize: '24px', fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'}}>Users</h3>
                  <p className="text-gray-600 leading-relaxed" style={{color: '#000000', fontSize: '18px', marginLeft: '15px'}}>
                    Pay only for content you want. Vote with your money to shape the ecosystem. Become a curator and earn from your predictions.
                  </p>
                </div>
              </div>
              <div className="flex gap-6 items-start group">
                <div className="w-16 h-16 rounded-full bg-[#6FF000] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <span className="text-2xl font-bold" style={{color: '#000000'}}>3</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2" style={{fontSize: '24px', fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"'}}>Platform</h3>
                  <p className="text-gray-600 leading-relaxed" style={{color: '#000000', fontSize: '18px', marginLeft: '15px'}}>
                    Sustainable growth through aligned incentives. A thriving ecosystem where quality content naturally rises to the top.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* 6. The shift from ads to direct value */}
        <section className="py-24 bg-white" style={{marginTop: '38px'}}>
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-2 font-serif" style={{fontWeight: '400', fontFamily: '"Abril Fatface", serif', fontSize: '39px'}}>The shift from ads to direct value</h2>
              <p className="text-gray-500 text-sm uppercase tracking-widest" style={{fontWeight: '500'}}>Market Trends</p>
            </div>

            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                <img src="/images/chart.png" alt="Market Trend Chart" className="w-full h-auto object-cover" />
              </div>
              <p className="text-gray-600 text-sm max-w-2xl leading-relaxed mx-auto" style={{color: '#000000', fontSize: '18px', whiteSpace: 'nowrap', width: '100%'}}>
                The market is rapidly shifting away from attention-based ad models towards direct value exchange, driven by the need for quality curation.
              </p>
            </div>
          </div>
        ...
        <section className="py-24 bg-white" style={{marginTop: '0px'}}>
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-2 font-serif" style={{fontWeight: '400', fontFamily: '"Abril Fatface", serif', fontSize: '39px'}}>Simple math</h2>
              <p className="text-gray-500 text-sm uppercase tracking-widest" style={{fontWeight: '500'}}>The Numbers Speak</p>
            </div>

            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                <img src="/images/simple-math-chart.png" alt="Simple Math Chart" className="w-full h-auto object-cover" />
              </div>
              <p className="text-gray-600 text-sm max-w-2xl leading-relaxed mx-auto" style={{color: '#000000', fontSize: '18px', whiteSpace: 'nowrap', width: '100%'}}>
                At just 1% conversion on 10M monthly users with $1 average transaction value, TaleX generates $100K daily for creators.
              </p>
            </div>
          </div>
        </section>

        {/* 8. Risk control and safety */}
        <section className="py-24 bg-white" style={{marginTop: '-3px', height: '679px'}}>
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-2 font-serif" style={{fontWeight: '400', fontFamily: '"Abril Fatface", serif', fontSize: '39px'}}>Risk control and safety</h2>
              <p className="text-gray-500 text-sm uppercase tracking-widest" style={{fontWeight: '500'}}>Protecting the Ecosystem</p>
            </div>

            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                <img src="/images/risk-control-chart.png" alt="Risk Control Chart" className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </section>

        {/* 9. A new way of value discovery */}
        <section className="py-24 bg-gradient-to-b from-white to-[#F0FDF4]" style={{marginTop: '0px'}}>
          <div className="container text-center" style={{backgroundImage: 'url(/images/new-way-value-discovery.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', position: 'relative', zIndex: '10'}}>
            <h2 className="text-4xl font-bold mb-2 font-serif" style={{fontSize: '39px', fontWeight: '400', fontFamily: '"Abril Fatface", serif'}}>A new way of value discovery</h2>
            <p className="text-xl text-gray-600 mb-12 mx-auto whitespace-nowrap" style={{color: '#000000', width: '100%', fontWeight: '500'}}>
              Redefining "Tipping" from an emotional expression to a systematic tool for content discovery and growth.
            </p>
            <Button className="bg-black hover:bg-[#6FF000] text-white hover:text-black font-bold rounded-full px-12 py-8 text-xl shadow-xl shadow-black/30 hover:shadow-[#6FF000]/30 transition-all hover:scale-105" style={{paddingRight: '40px', paddingLeft: '40px'}} onClick={() => window.location.href = 'https://www.talex.world/publish'}>
