          ...
          <div className="container">
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
              <div className="flex justify-center relative">
                <img ref={phoneRef} src="/images/sharing-chain-phone.png" alt="The Sharing Chain" className="w-full max-w-sm h-auto drop-shadow-2xl rounded-3xl cursor-pointer" onMouseMove={handleMouseMove} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} onClick={() => window.open('https://www.talex.world/reading/585449588677', '_self')} style={{padding: '5%', boxSizing: 'border-box'}} />
                {isHovering && (
