...
export default function Model() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-black">
      ...
      <div className="pt-20">
        {/* 1. Hero Section */}
        <section className="relative py-24 overflow-hidden bg-white model-hero-section" style={{height: '595px'}}>
...
The 20% payment creates a direct value exchange. It signals genuine appreciation and supports the creator's livelihood.
                  ...
                  <div style={{marginTop: '-16px'}}>
                    <h3 className="text-xl font-bold mb-4 text-[#6FF000]" style={{color: '#000000', paddingLeft: '84px'}}>2. Prediction Logic</h3>
              ...
              <div className="relative h-[333px] flex flex-col items-center justify-center">
