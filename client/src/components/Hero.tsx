        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center" style={{marginTop: '-60px', marginLeft: '-6px', width: '1250px', height: '757px'}}>
          ...
          <div className="relative mt-12 lg:mt-0">
            ...
            <div className="relative w-full flex items-center justify-center">
              <img src="/images/hero-mockup.png" alt="App Interface" className="w-full h-auto object-contain" style={{width: '847px', height: '665px', maxWidth: 'none', marginTop: '-74px', marginRight: '126px', marginLeft: '7px', paddingLeft: '54px'}} />
            </div>
          </div>
        </div>
      </div>
