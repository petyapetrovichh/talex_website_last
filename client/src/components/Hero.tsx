    ...
    <section className="relative pt-32 pb-20 overflow-hidden bg-white">
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          <div className="max-w-2xl" style={{marginRight: '-100px', marginLeft: '50px'}}>
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed w-full max-w-[815px]" style={{color: '#000000', fontSize: '19px'}}>
          ...
          <div className="hidden lg:flex items-center justify-center">
            <img src="/images/app-interface-mockup.png" alt="TaleX App Interface" className="w-full h-auto object-contain max-w-[600px]" style={{marginTop: '-50px', objectFit: 'cover', width: '735px', height: '675px'}} />
          </div>
        </div>
      </div>
    </section>
