      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          <div className="max-w-2xl">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1] mb-6 w-full max-w-[559px]" style={{fontSize: '39px'}}>
              TaleX is where <br />
          ...
          <div className="relative mt-12 lg:mt-0">
            ...
            <div className="relative w-full flex items-center justify-center">
              <img src="/hero-updated.png" alt="App Interface" className="w-full h-auto object-contain max-w-[500px] lg:max-w-[861px] mx-auto lg:ml-auto lg:mr-0 lg:-mt-[51px]" />
            </div>
          </div>
        </div>
      </div>
