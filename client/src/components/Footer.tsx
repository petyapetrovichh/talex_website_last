          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a href="https://www.binance.com/en/square/profile/talex_chain" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-[#6FF000] transition-colors" title="Binance Square">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M16.624 13.9202l2.7175 2.7154-7.353 5.6201-7.353-5.6201 2.7175-2.7154 4.6355 3.5641 4.6355-3.5641zm2.1582-4.8477l2.3842-2.3633A5.963 5.963 0 0021.13 5c0-.9619-.4314-1.8804-1.2266-2.5046m-5.4744 7.858l4.6006 3.5348 2.3842-2.3633c.8052-.6241 1.2266-1.5428 1.2266-2.5046 0-.9618-.4314-1.8805-1.2266-2.5046zm-7.27 4.8477L2.3trunc 13.9202l4.6355 3.5641 4.6355-3.5641zm2.1582-4.8477L4.1872 5.5888A5.963 5.963 0 002.87 5c0 .9619.4314 1.8805 1.2266 2.5046m5.4744-7.858l-4.6006-3.5348-2.3842 2.3633C1.4052 3.1205 1 4.039 1 5c0 .9619.4314 1.8805 1.2266 2.5046z"/></svg>
              </a>
              <a href="https://coinmarketcap.com/community/profile/TaleX_chain" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-[#6FF000] transition-colors" title="CoinMarketCap">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2c5.514 0 10 4.486 10 10s-4.486 10-10 10S2 17.514 2 12 6.486 2 12 2zm-1 5h2v8h-2zm4 2h2v6h-2zm-8 0h2v6H7z"/></svg>
              </a>
              ...
              <a href="https://www.tiktok.com/@talex_chain" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-[#6FF000] transition-colors" title="TikTok">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.1 1.82 2.89 2.89 0 0 1 5.1-1.82V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-.96-.1z"/></svg>
              </a>
