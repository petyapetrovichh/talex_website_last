...
const features = [
  {
    ...
    buttonLink: "https://www.talex.world/publish"
  },
  {
    image: "/13.png",
  ...
  },
  {
    ...
    buttonLink: "https://www.talex.world/"
  },
  {
    image: "/15.png",
  ...
  return (
    <section className="bg-white" style={{marginTop: '119px'}}>
      {/* =========================================
          ...
          ========================================= */}
      <div className="md:hidden py-16 px-6" style={{marginTop: '-119px'}}>
        <h2 className="text-3xl font-bold text-center mb-12" style={{fontSize: '22px', color: '#000000', fontWeight: '400'}}>Why Creators Choose TaleX</h2>
      ...
      <div className="hidden md:block container py-24" style={{marginBottom: '197px', marginTop: '-95px'}}>
        <h2 className="text-4xl font-bold text-center mb-20" style={{fontSize: '39px', fontWeight: '400', color: '#000000'}}>Why Creators Choose TaleX</h2>
        ...
        <div className="max-w-4xl mx-auto space-y-16 h-auto">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-3" style={{fontWeight: '800', fontFamily: 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"', color: '#000000'}}>{feature.title}</h3>
