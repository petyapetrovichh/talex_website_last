...
function Feature({ title, description, imageSrc, imageAlt, reverse, buttonText = "Start exploring in the app" }: FeatureProps) {
  return (
    <>
      {/* 移动端版本 */}
      <div className="md:hidden flex flex-col items-center gap-12 py-12 w-full relative" style={{height: '777px'}}>
        <div className="flex-1 w-full flex justify-center"></div>
        
        <div className="flex-1 space-y-6 text-center w-full" style={{marginLeft: '60px', marginRight: '-100px', marginTop: '200px'}}>
          <h2 className="w-full" style={{fontSize: '24px', fontWeight: '400', lineHeight: '1.25', marginBottom: '1.5rem', color: '#000000'}}>
            {title}
          </h2>
          <p className="w-full" style={{fontSize: '16px', color: '#000000', lineHeight: '1.625', marginBottom: '2rem'}}>
            {description}
          </p>
          <Button 
            onClick={() => window.location.href = 'https://www.talex.world/reading/585449588677'}
            className="bg-[#6FF000] hover:bg-black text-black hover:text-white font-bold rounded-full px-8 py-6 text-lg shadow-lg shadow-[#6FF000]/20 transition-all hover:scale-105"
      ...
      <div className={`hidden md:flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-12 lg:gap-24 py-12 lg:py-24 w-full relative`} style={{height: '777px'}}>
        ...
        <div className="flex-1 space-y-6 text-center lg:text-left w-full" style={{marginLeft: '60px', marginRight: '-100px', marginTop: '200px'}}>
          <h2 className="w-full" style={{fontSize: '39px', fontWeight: '400', lineHeight: '1.25', marginBottom: '1.5rem', color: '#000000'}}>
            {title}
          </h2>
          <p className="w-full" style={{fontSize: '18px', color: '#000000', lineHeight: '1.625', marginBottom: '2rem'}}>
            {description}
          </p>
          <Button 
            onClick={() => window.location.href = 'https://www.talex.world/reading/585449588677'}
...
It's designed to help people build their own information pathways.`}
      ...
      {/* 移动端版本 */}
      <div className="md:hidden relative w-full" style={{height: '400px', marginTop: '100px'}}>
        <img
